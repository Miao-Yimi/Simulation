...
#include "../../PlantSimulation/Widgets/EditWidget.h"
...
QT_MOC_LITERAL(3, 24, 14) // "sendKeyPressed"

    },
    "EditWidget\0sendClicked\0\0sendKeyPressed"
};
...
void EditWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendKeyPressed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (EditWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditWidget::sendClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (EditWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditWidget::sendKeyPressed)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject EditWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EditWidget.data,
      qt_meta_data_EditWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void EditWidget::sendClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void EditWidget::sendKeyPressed()
{
